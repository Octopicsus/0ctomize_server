...
exports.classifyTransactionText = classifyTransactionText;
...
function classifyTransactionText(title, description, txType) {
...
function autoClassify(doc) {
    const title = doc.title || '';
    const description = doc.description || '';
    const txType = doc.type === 'Income' ? 'Income' : 'Expense';
