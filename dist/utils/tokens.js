...
const generateTokens = (userId, email) => {
    const accessToken = jsonwebtoken_1.default.sign({ id: userId, email, type: 'access' }, JWT_SECRET, { expiresIn: '15m' });
    const refreshToken = jsonwebtoken_1.default.sign({ id: userId, email, type: 'refresh' }, JWT_REFRESH_SECRET, { expiresIn: '7d' });
